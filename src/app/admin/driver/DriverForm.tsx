...
<div className="">
 ...
 {/* Incase of emergency  */}
  ...
  <div>
    ...
    >
      <option value="" disabled>Select City</option>
      {operator.emergency_region && Object.keys(data[operator.emergency_region]).map((city) => (
        <option key={city} value={city}>
          {city}
        </option>
      ))}
  ...
  <div>
    ...
    >
      <option value="" disabled>Select Barangay</option>
      {operator.emergency_city && data[operator.emergency_region][operator.emergency_city].map((brgy) => (
        <option key={brgy} value={brgy}>
          {brgy}
        </option>
      ))}
